...
exports.PROFILE_ANALYZER_USER_PROMPT = exports.PROFILE_ANALYZER_SYSTEM_PROMPT = void 0;
exports.formatProfileAnalyzerPrompt = formatProfileAnalyzerPrompt;
exports.PROFILE_ANALYZER_SYSTEM_PROMPT = `You are an expert at analyzing LinkedIn profiles to identify valuable talking points and connection opportunities for cold outreach.
...
exports.PROFILE_ANALYZER_USER_PROMPT = `Analyze this LinkedIn profile for cold outreach opportunities:
...
function formatProfileAnalyzerPrompt(targetProfileText, userProfile) {
    return exports.PROFILE_ANALYZER_USER_PROMPT
