...
function IndexSidePanel() {
    ...
    const [generateState, setGenerateState] =
        useState<GenerateState>("checking");
            ...
            try {
                ...
                if (newUrl?.includes("linkedin.com/in/")) {
                    ...
                    if (currentProfileUrlRef.current !== newUrl) {
                        console.log(
                            "New LinkedIn profile detected. Resetting state."
                        );
                        setGenerateState("idle");
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            try {
                ...
                throw new Error(
                    "Could not connect to LinkedIn page. Please refresh the page (F5 or Cmd+R) and try again."
                );
            }
            ...
            if (!extractResponse.success) {
                throw new Error(
                    extractResponse.error +
                        " Please refresh the page (F5 or Cmd+R) and try again."
                );
            }
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="text-xs text-gray-500 space-y-1 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    <p>
                                        <strong>New Version:</strong> Fresh
                                        message from scratch
                                    </p>
                                    <p>
                                        <strong>Polish:</strong> Refine current
                                        message
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                {!aiAvailable && (
                                    <p className="text-xs text-center text-red-600">
                                        Chrome AI is not available. Check
                                        Settings tab.
                                    </p>
                                )}
                            </div>
